...
static int f2fs_create_whiteout(struct inode *dir, struct inode **whiteout, struct f2fs_filename *fname)
{
	return __f2fs_tmpfile(dir, NULL, S_IFCHR | WHITEOUT_MODE, true, whiteout, fname);
}
